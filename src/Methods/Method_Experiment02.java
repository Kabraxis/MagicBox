...
public class Method_Experiment02 {
    public static void main(String[] args) {
        // I can either set a new variable and initialize it by a call of the desired method, containing the desired values and print it by
        // passing the new variable to the print method
